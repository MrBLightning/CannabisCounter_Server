...
import { DataProductCampaignController } from './data-product-campaign/data-product-campaign.controller';
import { DataProductCampaignService } from './data-product-campaign/data-product-campaign.service';
import { DataSubSuppliersController } from './data-subsuppliers/data-subsuppliers.controller';
import { DataSubSuppliersService } from './data-subsuppliers/data-subsuppliers.service';
@Module({
    ...
    controllers: [
        ...
        DataProductCampaignController,
        DataSubSuppliersController
    ],
    providers: [
        ...
        DataProductCampaignService,
        DataSubSuppliersService
    ],
})
