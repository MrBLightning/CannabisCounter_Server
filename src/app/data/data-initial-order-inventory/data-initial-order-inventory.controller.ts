...
@Controller('data/initialOrderInventory')
@UseGuards(AuthGuard('jwt'))
export class DataInitialOrderInventoryController {
    ...
    @Get("/:BranchId")
    async getInitialOrderInventory(@ReqUser() user: AuthUser, @Param('BranchId') BranchId: number) {
